...
export const create = createRoute({
  ...
  method: "post",
  request: {
    body: jsonContentRequired(insertEmployeesSchema, "Employee to create"),
  },
  tags,
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
    ...
    [HttpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(
      createErrorSchema(insertEmployeesSchema),
      "Validation error(s)",
    ),
  },
})
...
export const getOne = createRoute({
  ...
  responses: {
    ...
    [HttpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(
      createErrorSchema(EmployeeIdParamsSchema),
      "Invalid id error",
    ),
  },
})
...
export const patch = createRoute({
  ...
  request: {
    ...
    body: jsonContentRequired(patchEmployeesSchema, "Employee updates"),
  },
  tags,
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
    ...
    [HttpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(
      createErrorSchema(patchEmployeesSchema).or(
        createErrorSchema(EmployeeIdParamsSchema),
      ),
      "Validation error(s)",
    ),
