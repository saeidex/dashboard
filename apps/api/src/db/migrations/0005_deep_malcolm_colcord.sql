...
ALTER TABLE `employees` ALTER COLUMN "position" TO "position" text DEFAULT 'Helper';--> statement-breakpoint
...
ALTER TABLE `categories` ALTER COLUMN "image" TO "image" blob NOT NULL;