...
ALTER TABLE `employees` ALTER COLUMN "position" TO "position" text;--> statement-breakpoint
...
ALTER TABLE `employees` ALTER COLUMN "shift" TO "shift" text;--> statement-breakpoint
ALTER TABLE `employees` ALTER COLUMN "status" TO "status" text;--> statement-breakpoint
ALTER TABLE `employees` ALTER COLUMN "salary" TO "salary" integer NOT NULL;--> statement-breakpoint
ALTER TABLE `employees` ALTER COLUMN "hire_date" TO "hire_date" integer NOT NULL;