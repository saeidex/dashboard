...
import { IconLayoutFull } from "@/web/assets/custom/icon-layout-full";
import { IconSidebarFloating } from "@/web/assets/custom/icon-sidebar-floating";
import { IconSidebarInset } from "@/web/assets/custom/icon-sidebar-inset";
import { IconSidebarSidebar } from "@/web/assets/custom/icon-sidebar-sidebar";
import { IconThemeDark } from "@/web/assets/custom/icon-theme-dark";
import { IconThemeLight } from "@/web/assets/custom/icon-theme-light";
import { IconThemeSystem } from "@/web/assets/custom/icon-theme-system";
