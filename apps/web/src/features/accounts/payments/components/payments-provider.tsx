...
type PaymentsContextType = {
  ...
  setCurrentRow: React.Dispatch<React.SetStateAction<PaymentWithRelations | null>>;
};
...
export function PaymentsProvider({ children }: { children: React.ReactNode }) {
  ...
  const [currentRow, setCurrentRow] = useState<PaymentWithRelations | null>(null);
