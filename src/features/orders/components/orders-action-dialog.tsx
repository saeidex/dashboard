...
import { orderItemSchema, orderSchema, type Order } from '../data/schema'
import { OrderItemsEditor, type EditableOrderItem } from './order-items-editor'
...
export function OrdersActionDialog({
  ...
  return (
    ...
    >
      <DialogContent className='max-h-[calc(100vh-6rem)] overflow-y-auto rounded-xs sm:max-w-xl lg:max-w-5xl'>
