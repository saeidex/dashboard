...
import type { CreateRoute, GetOneRoute, ListRoute, PatchRoute, RemoveRoute } from "./expenses.routes";
...
export const create: AppRouteHandler<CreateRoute> = async (c) => {
  ...
  const [inserted] = await db.insert(expenses).values({ id, ...payload }).returning();
